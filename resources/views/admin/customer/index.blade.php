...
<div class="mb-9">
    <div id="projectSummary" data-list='{"valueNames":["projectName","assigness","start","deadline","task","projectprogress","status","action"],"page":6,"pagination":true}'>
      <div class="row mb-4 gx-6 gy-3 align-items-center">
        ...
        <div class="col-auto"><a class="btn btn-primary px-5" href="{{ url('admin/customers/create') }}"><i class="fa-solid fa-plus me-2"></i>Add new customer</a></div>
      </div>
      ...
      <div class="table-responsive scrollbar">
        <table class="table fs--1 mb-0 border-top border-200">
          <thead>
            <tr>
              <th class="sort align-middle ps-3" scope="col" data-sort="projectName" style="width:10%;">CUSTOMER NAME</th>
          ...
          <tbody class="list" id="table-latest-review-body">
            ...
            <tr class="position-static">
                <td class="align-middle white-space-nowrap ps-3 projectName py-4">{{ $customer->name }}</td>
                <td class="align-middle white-space-nowrap assigness ps-3 py-4">
                  ...
                  <div class="avatar-group avatar-group-dense">
                    <div class="avatar avatar-s  rounded-circle">
                      <img class="rounded-circle " src="{{ asset($customer->image) }}" alt="" />
                    </div>
                  </div>
                  @endif
                </td>
                ...
                <td >
                  <a class="btn btn-primary btn-sm" href="{{ url('admin/customers/'.$customer->id.'/edit') }}"><i class="far fa-edit"></i></a>
                  <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this data?')" href="{{ url('admin/customers/'.$customer->id.'/delete') }}"><i class="far fa-trash-alt"></i></a>
