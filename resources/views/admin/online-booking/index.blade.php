        ...
        <table class="table fs--1 mb-0 border-top border-200">
          <thead>
            <tr>
              ...
              <th class="sort align-middle ps-3" scope="col" data-sort="deadline" style="width:10%;">ADULTS BOOKING</th>
              <th class="sort align-middle ps-3" scope="col" data-sort="deadline" style="width:10%;">CHILDS BOOKING</th>
          ...
          <tbody class="list" id="table-latest-review-body">
            ...
            <tr class="position-static">
                ...
                <td class="align-middle white-space-nowrap start ps-3 py-4">
                  {{ $booking->adults_booking }}
                </td>
                <td class="align-middle white-space-nowrap deadline ps-3 py-4">
                    {{ $booking->childs_booking }}
                </td>
